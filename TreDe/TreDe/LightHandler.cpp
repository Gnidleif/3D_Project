	...
	//mSpots(new SpotLight[mSpotAmount])
{
	...
	mDirs[0].Direction = XMFLOAT3(-0.57735f, -0.57735f, 0.57735f);
	...
	mPoints[1].Ambient = LightLights::WHITE;
	...
	mPoints[1].Range = 100.0f;
	mPoints[1].Position = XMFLOAT3(0.0f, 15.0f, 0.0f);
